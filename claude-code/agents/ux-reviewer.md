...
1. Use `WebSearch` to look up current UX best practices for the specific UI pattern
2. Look for 2-3 well-known products that solve a similar UI problem
...
- [file:line] [description] — [what's suboptimal]
  -> Suggestion: [specific improvement]
...
## What Works Well
- [call out 1-2 things the implementation does right]
...
- **Prioritize user impact** — MUST FIX = users confused/blocked, SHOULD FIX = degraded experience, NITPICK = polish
- **Cite research** — link sources so the team can evaluate
